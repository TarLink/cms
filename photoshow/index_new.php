...
function my_2_autoload($class){
	if(file_exists(dirname(__FILE__)."/../extendPhotoshow/$class.php")){
		require(dirname(__FILE__)."/../extendPhotoshow/$class.php");
	}else{
		return FALSE;
	}
}
...
spl_autoload_register("my_2_autoload");
